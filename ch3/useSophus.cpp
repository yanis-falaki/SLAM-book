...
int main(int argc, char **argv)
{
    ...
    // Or quaternion
    Quaterniond q(R);
    Sophus::SO3d SO3_R(R); // Sophus::SO3d can be constructed from a rotation matrix
    Sophus::SO3d SO3_q(q); // or quaternion, they are equivalent
    ...
    Sophus::SE3d SE3_qt(q, t); // Construction from q, t
    cout << "SE3 from R,t = \n"
         << SE3_Rt.matrix() << endl;
    cout << "SE3 from q,t = \n"
         << SE3_qt.matrix() << endl;
